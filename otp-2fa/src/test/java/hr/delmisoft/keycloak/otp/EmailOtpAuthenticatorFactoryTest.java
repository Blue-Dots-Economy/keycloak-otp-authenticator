...
class EmailOtpAuthenticatorFactoryTest {
    ...
    void getConfigProperties_returnsFourProperties() {
        ...
        assertThat(props.get(3).getName(), equalTo(EmailOtpConst.CONFIG_MARK_VERIFIED));
    }
    ...
    void getConfigProperties_haveDefaults() {
        ...
        assertThat(props.get(3).getDefaultValue(), equalTo(String.valueOf(EmailOtpConst.DEFAULT_MARK_VERIFIED)));
    }
